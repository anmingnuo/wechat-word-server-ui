<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="每日学习目标" prop="dailyGoal">
        <el-input
          v-model="queryParams.dailyGoal"
          placeholder="请输入每日学习目标"
          clearable
    ...
    <el-table v-loading="loading" :data="planList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="每日学习目标" align="center" prop="dailyGoal" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="每日学习目标" prop="dailyGoal">
          <el-input v-model="form.dailyGoal" placeholder="请输入每日学习目标" />
        </el-form-item>
        <el-form-item label="删除标记" prop="isDeleted">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        dailyGoal: [
          { required: true, message: "每日学习目标不能为空", trigger: "blur" }
        ],
        createTime: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除学习计划管理编号为"' + ids + '"的数据项？').then(function() {
        return delPlan(ids);
      }).then(() => {
        this.getList();
