<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:sentence:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:sentence:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:sentence:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:sentence:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="sentenceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="例句id" align="center" prop="id" />
      <el-table-column label="单词名称" align="center" prop="word.wordName" />
      <el-table-column label="英文" align="center" prop="english" />
...
<script>
import { listSentence, getSentence, delSentence, addSentence, updateSentence } from "@/api/system/sentence";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除例句管理编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/sentence/export', {
        ...this.queryParams
