<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="连续签到天数" prop="continueNumber">
        <el-input
          v-model="queryParams.continueNumber"
    ...
    <el-table v-loading="loading" :data="inList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="连续签到天数" align="center" prop="continueNumber" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="连续签到天数" prop="continueNumber">
          <el-input v-model="form.continueNumber" placeholder="请输入连续签到天数" />
        </el-form-item>
        <el-form-item label="删除标记" prop="isDeleted">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除签到管理编号为"' + ids + '"的数据项？').then(function() {
        return delIn(ids);
      }).then(() => {
        this.getList();
